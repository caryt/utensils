...
class Float_Quantity(Qty, float):
	...
	.. inheritance-diagram:: Float_Quantity
...
class Fixed_Quantity(Float_Quantity):
	...
	.. inheritance-diagram:: Fixed_Quantity
...
class Percent_Quantity(Float_Quantity):
	"""A percentage. Transparently handles a divisor of 100.
	(e.g. `Percent(5)` is displayed as 5% and stored as 0.05).

	.. inheritance-diagram:: Percent_Quantity
...
class Fractional_Quantity(Qty, Fraction):
	...
	.. inheritance-diagram:: Fractional_Quantity
